...
type
  TSCardEstablishContext = function(dwScope: DWORD; pvReserved1: Pointer; pvReserved2: Pointer; phContext: Pointer)
    : Integer; stdcall;
  TSCardReleaseContext = function(hContext: Integer): Integer; stdcall;
  TSCardIsValidContext = function(hContext: Integer): Integer; stdcall;
{$ELSE}
function SCardEstablishContext(dwScope: DWORD; pvReserved1: Pointer; pvReserved2: Pointer; phContext: Pointer)
  : Integer; stdcall;
{$EXTERNALSYM SCardEstablishContext}
function SCardReleaseContext(hContext: Integer): Integer; stdcall;
{$EXTERNALSYM SCardReleaseContext}
function SCardIsValidContext(hContext: Integer): Integer; stdcall;
...
type
  TSCardListReaderGroupsA = function(hContext: Integer; mszGroups: LPSTR; var pcchGroups: Integer): Integer; stdcall;
  TSCardListReaderGroupsW = function(hContext: Integer; mszGroups: LPWSTR; var pcchGroups: Integer): Integer; stdcall;
...
{$ENDIF}
  TSCardListReadersA = function(SCARDCONTEXT: Integer; mszGroups: LPSTR; mszReaders: LPSTR; var pcchReaders: Integer)
    : Integer; stdcall;
  TSCardListReadersW = function(SCARDCONTEXT: Integer; mszGroups: LPWSTR; mszReaders: LPWSTR; var pcchReaders: Integer)
    : Integer; stdcall;
...
{$ENDIF}
  TSCardListCardsA = function(hContext: Integer; var pbAtr: Byte; var rgguidInterfaces: GUID;
    cguidInterfaceCount: Integer; mszCards: LPSTR; var pcchCards: Integer): Integer; stdcall;
  TSCardListCardsW = function(hContext: Integer; var pbAtr: Byte; var rgguidInterfaces: GUID;
    cguidInterfaceCount: Integer; mszCards: LPWSTR; var pcchCards: Integer): Integer; stdcall;
...
{$ENDIF}
{$ELSE}
function SCardListReaderGroupsA(hContext: Integer; mszGroups: LPSTR; var pcchGroups: Integer): Integer; stdcall;
{$EXTERNALSYM SCardListReaderGroupsA}
function SCardListReaderGroupsW(hContext: Integer; mszGroups: LPWSTR; var pcchGroups: Integer): Integer; stdcall;
{$EXTERNALSYM SCardListReaderGroupsW}
function SCardListReadersA(SCARDCONTEXT: Integer; mszGroups: LPSTR; mszReaders: LPSTR; var pcchReaders: Integer)
  : Integer; stdcall;
{$EXTERNALSYM SCardListReadersA}
function SCardListReadersW(SCARDCONTEXT: Integer; mszGroups: LPWSTR; mszReaders: LPWSTR; var pcchReaders: Integer)
  : Integer; stdcall;
{$EXTERNALSYM SCardListReadersW}
function SCardListCardsA(hContext: Integer; var pbAtr: Byte; var rgguidInterfaces: GUID; cguidInterfaceCount: Integer;
  mszCards: LPSTR; var pcchCards: Integer): Integer; stdcall;
{$EXTERNALSYM SCardListCardsA}
function SCardListCardsW(hContext: Integer; var pbAtr: Byte; var rgguidInterfaces: GUID; cguidInterfaceCount: Integer;
  mszCards: LPWSTR; var pcchCards: Integer): Integer; stdcall;
...
type
  ...
  TSCardListInterfacesA = function(hContext: Integer; szCard: LPSTR; var pguidInterfaces: GUID;
    var pcguidInterfaces: Integer): Integer; stdcall;
  TSCardListInterfacesW = function(hContext: Integer; szCard: LPWSTR; var pguidInterfaces: GUID;
    var pcguidInterfaces: Integer): Integer; stdcall;
...
{$ENDIF}
  TSCardGetProviderIdA = function(hContext: Integer; szCard: LPSTR; var pguidProviderId: GUID): Integer; stdcall;
  TSCardGetProviderIdW = function(hContext: Integer; szCard: LPWSTR; var pguidProviderId: GUID): Integer; stdcall;
...
{$ENDIF}
{$ELSE}
function SCardListInterfacesA(hContext: Integer; szCard: LPSTR; var pguidInterfaces: GUID;
  var pcguidInterfaces: Integer): Integer; stdcall;
{$EXTERNALSYM SCardListInterfacesA}
function SCardListInterfacesW(hContext: Integer; szCard: LPWSTR; var pguidInterfaces: GUID;
  var pcguidInterfaces: Integer): Integer; stdcall;
{$EXTERNALSYM SCardListInterfacesW}
function SCardGetProviderIdA(hContext: Integer; szCard: LPSTR; var pguidProviderId: GUID): Integer; stdcall;
{$EXTERNALSYM SCardGetProviderIdA}
function SCardGetProviderIdW(hContext: Integer; szCard: LPWSTR; var pguidProviderId: GUID): Integer; stdcall;
...
type
  TSCardGetCardTypeProviderNameA = function(hContext: Integer; szCardName: LPSTR; dwProviderId: Integer;
    szProvider: LPSTR; var pcchProvider: Integer): Integer; stdcall;
  TSCardGetCardTypeProviderNameW = function(hContext: Integer; szCardName: LPWSTR; dwProviderId: Integer;
    szProvider: LPWSTR; var pcchProvider: Integer): Integer; stdcall;
...
{$ENDIF}
{$ELSE}
function SCardGetCardTypeProviderNameA(hContext: Integer; szCardName: LPSTR; dwProviderId: Integer; szProvider: LPSTR;
  var pcchProvider: Integer): Integer; stdcall;
{$EXTERNALSYM SCardGetCardTypeProviderNameA}
function SCardGetCardTypeProviderNameW(hContext: Integer; szCardName: LPWSTR; dwProviderId: Integer; szProvider: LPWSTR;
  var pcchProvider: Integer): Integer; stdcall;
...
type
  TSCardIntroduceReaderGroupA = function(hContext: Integer; szGroupName: LPSTR): Integer; stdcall;
  TSCardIntroduceReaderGroupW = function(hContext: Integer; szGroupName: LPWSTR): Integer; stdcall;
...
{$ENDIF}
  TSCardForgetReaderGroupA = function(hContext: Integer; szGroupName: LPSTR): Integer; stdcall;
  TSCardForgetReaderGroupW = function(hContext: Integer; szGroupName: LPWSTR): Integer; stdcall;
{$IFDEF UNICODE}
  TSCardForgetReaderGroup = TSCardForgetReaderGroupW;
{$ELSE}
  TSCardForgetReaderGroup = TSCardForgetReaderGroupA;
{$ENDIF}
  TSCardIntroduceReaderA = function(hContext: Integer; szReadeName: LPSTR; szDeviceName: LPSTR): Integer; stdcall;
  TSCardIntroduceReaderW = function(hContext: Integer; szReadeName: LPWSTR; szDeviceName: LPWSTR): Integer; stdcall;
{$IFDEF UNICODE}
  TSCardIntroduceReader = TSCardIntroduceReaderW;
{$ELSE}
  TSCardIntroduceReader = TSCardIntroduceReaderA;
{$ENDIF}
  TSCardForgetReaderA = function(hContext: Integer; szReaderName: LPSTR): Integer; stdcall;
  TSCardForgetReaderW = function(hContext: Integer; szReaderName: LPWSTR): Integer; stdcall;
{$IFDEF UNICODE}
  TSCardForgetReader = TSCardForgetReaderW;
{$ELSE}
  TSCardForgetReader = TSCardForgetReaderA;
{$ENDIF}
  TSCardAddReaderToGroupA = function(hContext: Integer; szReaderName: LPSTR; szGroupName: LPSTR): Integer; stdcall;
  TSCardAddReaderToGroupW = function(hContext: Integer; szReaderName: LPWSTR; szGroupName: LPWSTR): Integer; stdcall;
{$IFDEF UNICODE}
  TSCardAddReaderToGroup = TSCardAddReaderToGroupW;
{$ELSE}
  TSCardAddReaderToGroup = TSCardAddReaderToGroupA;
{$ENDIF}
  TSCardRemoveReaderFromGroupA = function(hContext: Integer; szReaderName: LPSTR; szGroupName: LPSTR): Integer; stdcall;
  TSCardRemoveReaderFromGroupW = function(hContext: Integer; szReaderName: LPWSTR; szGroupName: LPWSTR)
    : Integer; stdcall;
{$IFDEF UNICODE}
...
{$ENDIF}
  TSCardIntroduceCardTypeA = function(hContext: Integer; szCardName: LPSTR; var pguidPrimaryProvider: GUID;
    var pguidInterfaces: GUID; dwInterfaceCount: Integer; pbAtr: LPSTR; pbAtrMask: LPSTR; cbAtrLen: Integer)
    : Integer; stdcall;
  TSCardIntroduceCardTypeW = function(hContext: Integer; szCardName: LPWSTR; var pguidPrimaryProvider: GUID;
    var pguidInterfaces: GUID; dwInterfaceCount: Integer; pbAtr: LPWSTR; pbAtrMask: LPWSTR; cbAtrLen: Integer)
    : Integer; stdcall;
...
{$ENDIF}
  TSCardSetCardTypeProviderNameA = function(hContext: Integer; szCardName: LPSTR; dwProviderId: Integer;
    szProvider: LPSTR): Integer; stdcall;
  TSCardSetCardTypeProviderNameW = function(hContext: Integer; szCardName: LPWSTR; dwProviderId: Integer;
    szProvider: LPWSTR): Integer; stdcall;
{$IFDEF UNICODE}
...
{$ENDIF}
{$ELSE}
function SCardIntroduceReaderGroupA(hContext: Integer; szGroupName: LPSTR): Integer; stdcall;
{$EXTERNALSYM SCardIntroduceReaderGroupA}
function SCardIntroduceReaderGroupW(hContext: Integer; szGroupName: LPWSTR): Integer; stdcall;
{$EXTERNALSYM SCardIntroduceReaderGroupW}
function SCardForgetReaderGroupA(hContext: Integer; szGroupName: LPSTR): Integer; stdcall;
{$EXTERNALSYM SCardForgetReaderGroupA}
function SCardForgetReaderGroupW(hContext: Integer; szGroupName: LPWSTR): Integer; stdcall;
{$EXTERNALSYM SCardForgetReaderGroupW}
function SCardIntroduceReaderA(hContext: Integer; szReadeName: LPSTR; szDeviceName: LPSTR): Integer; stdcall;
{$EXTERNALSYM SCardIntroduceReaderA}
function SCardIntroduceReaderW(hContext: Integer; szReadeName: LPWSTR; szDeviceName: LPWSTR): Integer; stdcall;
{$EXTERNALSYM SCardIntroduceReaderW}
function SCardForgetReaderA(hContext: Integer; szReaderName: LPSTR): Integer; stdcall;
{$EXTERNALSYM SCardForgetReaderA}
function SCardForgetReaderW(hContext: Integer; szReaderName: LPWSTR): Integer; stdcall;
{$EXTERNALSYM SCardForgetReaderW}
function SCardAddReaderToGroupA(hContext: Integer; szReaderName: LPSTR; szGroupName: LPSTR): Integer; stdcall;
{$EXTERNALSYM SCardAddReaderToGroupA}
function SCardAddReaderToGroupW(hContext: Integer; szReaderName: LPWSTR; szGroupName: LPWSTR): Integer; stdcall;
{$EXTERNALSYM SCardAddReaderToGroupW}
function SCardRemoveReaderFromGroupA(hContext: Integer; szReaderName: LPSTR; szGroupName: LPSTR): Integer; stdcall;
{$EXTERNALSYM SCardRemoveReaderFromGroupA}
function SCardRemoveReaderFromGroupW(hContext: Integer; szReaderName: LPWSTR; szGroupName: LPWSTR): Integer; stdcall;
{$EXTERNALSYM SCardRemoveReaderFromGroupW}
function SCardIntroduceCardTypeA(hContext: Integer; szCardName: LPSTR; var pguidPrimaryProvider: GUID;
  var pguidInterfaces: GUID; dwInterfaceCount: Integer; pbAtr: LPSTR; pbAtrMask: LPSTR; cbAtrLen: Integer)
  : Integer; stdcall;
{$EXTERNALSYM SCardIntroduceCardTypeA}
function SCardIntroduceCardTypeW(hContext: Integer; szCardName: LPWSTR; var pguidPrimaryProvider: GUID;
  var pguidInterfaces: GUID; dwInterfaceCount: Integer; pbAtr: LPWSTR; pbAtrMask: LPWSTR; cbAtrLen: Integer)
  : Integer; stdcall;
{$EXTERNALSYM SCardIntroduceCardTypeW}
function SCardSetCardTypeProviderNameA(hContext: Integer; szCardName: LPSTR; dwProviderId: Integer; szProvider: LPSTR)
  : Integer; stdcall;
{$EXTERNALSYM SCardSetCardTypeProviderNameA}
function SCardSetCardTypeProviderNameW(hContext: Integer; szCardName: LPWSTR; dwProviderId: Integer; szProvider: LPWSTR)
  : Integer; stdcall;
...
type
  TSCardForgetCardTypeA = function(hContext: Integer; szCardName: LPSTR): Integer; stdcall;
  TSCardForgetCardTypeW = function(hContext: Integer; szCardName: LPWSTR): Integer; stdcall;
...
{$ENDIF}
{$ELSE}
function SCardForgetCardTypeA(hContext: Integer; szCardName: LPSTR): Integer; stdcall;
{$EXTERNALSYM SCardForgetCardTypeA}
function SCardForgetCardTypeW(hContext: Integer; szCardName: LPWSTR): Integer; stdcall;
...
type
  TSCardFreeMemory = function(hContext: Integer; pvMem: Integer): Integer; stdcall;

  TSCardAccessStartedEvent = function: Integer; stdcall;

  TSCardReleaseStartedEvent = function: Integer; stdcall;
{$ELSE}
function SCardFreeMemory(hContext: Integer; pvMem: Integer): Integer; stdcall;
{$EXTERNALSYM SCardFreeMemory}
function SCardAccessStartedEvent: Integer; stdcall;
{$EXTERNALSYM SCardAccessStartedEvent}
function SCardReleaseStartedEvent: Integer; stdcall;
...
{$EXTERNALSYM PSCARD_READERSTATEA}
  ...
  SCARD_READERSTATEA = record
    ...
    dwCurrentState: Integer; { current state of reader at time of call }
    dwEventState: Integer; { state of reader after state change }
    cbAtr: Integer; { Number of bytes in the returned ATR }
...
type
  TSCardLocateCardsA = function(hContext: Integer; mszCards: LPSTR; var rgReaderStates: PSCARD_READERSTATEA;
    cReaders: Integer): Integer; stdcall;
  TSCardLocateCardsW = function(hContext: Integer; mszCards: LPWSTR; var rgReaderStates: PSCARD_READERSTATEW;
    cReaders: Integer): Integer; stdcall;
...
{$ENDIF}
{$ELSE}
function SCardLocateCardsA(hContext: Integer; mszCards: LPSTR; var rgReaderStates: PSCARD_READERSTATEA;
  cReaders: Integer): Integer; stdcall;
{$EXTERNALSYM SCardLocateCardsA}
function SCardLocateCardsW(hContext: Integer; mszCards: LPWSTR; var rgReaderStates: PSCARD_READERSTATEW;
  cReaders: Integer): Integer; stdcall;
...
type
  TSCardLocateCardsByATRA = function(hContext: Integer; rgAtrMasks: LPSCARD_ATRMASK; cAtrs: DWORD;
    var rgReaderStates: SCARD_READERSTATEA; cReaders: DWORD): Integer; stdcall;
  TSCardLocateCardsByATRW = function(hContext: Integer; rgAtrMasks: LPSCARD_ATRMASK; cAtrs: DWORD;
    var rgReaderStates: SCARD_READERSTATEW; cReaders: DWORD): Integer; stdcall;
...
{$ENDIF}
  TSCardGetStatusChangeA = function(hContext: Integer; dwTimeout: Integer; rgReaderStates: LPSCARD_READERSTATEA;
    cReaders: Integer): Integer; stdcall;
  TSCardGetStatusChangeW = function(hContext: Integer; dwTimeout: Integer; rgReaderStates: LPSCARD_READERSTATEW;
    cReaders: Integer): Integer; stdcall;
{$IFDEF UNICODE}
...
{$ENDIF}
  TSCardCancel = function(hContext: Integer): Integer; stdcall;
{$ELSE}
function SCardLocateCardsByATRA(hContext: Integer; rgAtrMasks: LPSCARD_ATRMASK; cAtrs: DWORD;
  var rgReaderStates: SCARD_READERSTATEA; cReaders: DWORD): Integer; stdcall;
{$EXTERNALSYM SCardLocateCardsByATRA}
function SCardLocateCardsByATRW(hContext: Integer; rgAtrMasks: LPSCARD_ATRMASK; cAtrs: DWORD;
  var rgReaderStates: SCARD_READERSTATEW; cReaders: DWORD): Integer; stdcall;
{$EXTERNALSYM SCardLocateCardsByATRW}
// CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED
// CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED

function SCardGetStatusChangeA(hContext: SCARDCONTEXT; dwTimeout: Integer;
  var rgReaderStates: array of SCARD_READERSTATEA; cReaders: Integer): Integer; stdcall;
{$EXTERNALSYM SCardGetStatusChangeA}
// CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED
// CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED

function SCardGetStatusChangeW(hContext: Integer; dwTimeout: Integer; var rgReaderStates: array of SCARD_READERSTATEW;
  cReaders: Integer): Integer; stdcall;
{$EXTERNALSYM SCardGetStatusChangeW}
function SCardCancel(hContext: Integer): Integer; stdcall;
...
type
  TSCardConnectA = function(hContext: Integer; szReader: LPSTR; dwShareMode: Integer; dwPreferredProtocols: Integer;
    var phCard: Integer; var dwActiveProtocol: DWORD): Integer; stdcall;
  TSCardConnectW = function(hContext: Integer; szReader: LPWSTR; dwShareMode: Integer; dwPreferredProtocols: Integer;
    var phCard: Integer; var dwActiveProtocol: DWORD): Integer; stdcall;
{$IFDEF UNICODE}
...
{$ENDIF}
  TSCardReconnect = function(hCard: Integer; dwShareMode: Integer; dwPreferredProtocols: Integer;
    dwInitialization: Integer; var pdwActiveProtocol: Integer): Integer; stdcall;

  TSCardDisconnect = function(hCard: Integer; dwDisposition: Integer): Integer; stdcall;

  TSCardBeginTransaction = function(hCard: Integer): Integer; stdcall;

  TSCardEndTransaction = function(hCard: Integer; dwDisposition: Integer): Integer; stdcall;
{$ELSE}
function SCardConnectA(hContext: Integer; szReader: LPSTR; dwShareMode: Integer; dwPreferredProtocols: Integer;
  var phCard: Integer; pdwActiveProtocol: PDWORD): Integer; stdcall;
{$EXTERNALSYM SCardConnectA}
function SCardConnectW(hContext: Integer; szReader: LPWSTR; dwShareMode: Integer; dwPreferredProtocols: Integer;
  var phCard: Integer; var dwActiveProtocol: PDWORD): Integer; stdcall;
{$EXTERNALSYM SCardConnectW}
function SCardReconnect(hCard: Integer; dwShareMode: Integer; dwPreferredProtocols: Integer; dwInitialization: Integer;
  var pdwActiveProtocol: Integer): Integer; stdcall;
{$EXTERNALSYM SCardReconnect}
function SCardDisconnect(hCard: Integer; dwDisposition: Integer): Integer; stdcall;
{$EXTERNALSYM SCardDisconnect}
function SCardBeginTransaction(hCard: Integer): Integer; stdcall;
{$EXTERNALSYM SCardBeginTransaction}
function SCardEndTransaction(hCard: Integer; dwDisposition: Integer): Integer; stdcall;
...
type
  TSCardStatusA = function(hCard: Integer; mszReaderNames: LPSTR; var pcchReaderLen: Integer; var pdwState: Integer;
    pdwProtocol: PDWORD; pbAtr: PByte; var pcbAtrLen: Integer): Integer; stdcall;
  TSCardStatusW = function(hCard: Integer; mszReaderNames: LPWSTR; var pcchReaderLen: Integer; var pdwState: Integer;
    pdwProtocol: PDWORD; pbAtr: PByte; var pcbAtrLen: Integer): Integer; stdcall;
{$IFDEF UNICODE}
...
{$ENDIF}
  TSCardTransmit = function(hCard: Integer; pioSendPci: Pointer; pbSendBuffer: PByte; dwSendLength: DWORD;
    pioRecvPci: Pointer; pbRecvBuffer: PByte; var pcbRecvLength: DWORD): Integer; stdcall;
{$ELSE}
function SCardStatusA(hCard: Integer; mszReaderNames: LPSTR; var pcchReaderLen: Integer; var pdwState: Integer;
  pdwProtocol: PDWORD; pbAtr: PByte; var pcbAtrLen: Integer): Integer; stdcall;
{$EXTERNALSYM SCardStatusA}
function SCardStatusW(hCard: Integer; mszReaderNames: LPWSTR; var pcchReaderLen: Integer; var pdwState: Integer;
  pdwProtocol: PDWORD; pbAtr: PByte; var pcbAtrLen: Integer): Integer; stdcall;
{$EXTERNALSYM SCardStatusW}
function SCardTransmit(hCard: Integer; pioSendPci: Pointer; pbSendBuffer: PByte; dwSendLength: DWORD;
  pioRecvPci: Pointer; pbRecvBuffer: PByte; pcbRecvLength: PDWORD): Integer; stdcall;
...
type
  TSCardControl = function(hCard: Integer; dwControlCode: Integer; var pvInBuffer: PByte; cbInBufferSize: Integer;
    var pvOutBuffer: PByte; cbOutBufferSize: Integer; var pcbBytesReturned: Integer): Integer; stdcall;

  TSCardGetAttrib = function(hCard: Integer; dwAttrId: Integer; pbAttr: PByte; var pcbAttrLen: Integer)
    : Integer; stdcall;
{$ELSE}
function SCardControl(hCard: Integer; dwControlCode: Integer; var pvInBuffer: PByte; cbInBufferSize: Integer;
  var pvOutBuffer: PByte; cbOutBufferSize: Integer; var pcbBytesReturned: Integer): Integer; stdcall;
{$EXTERNALSYM SCardControl}
// CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED
// CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED CHANGED

function SCardGetAttrib(hCard: Integer; dwAttrId: Integer; pbAttr: PByte; pcbAttrLen: PDWORD): Integer; stdcall;
...
type
  ...
  TSCardSetAttrib = function(hCard: Integer; dwAttrId: Integer; var pbAttr: PByte; cbAttrLen: Integer)
    : Integer; stdcall;
{$ELSE}
function SCardSetAttrib(hCard: Integer; dwAttrId: Integer; var pbAttr: PByte; cbAttrLen: Integer): Integer; stdcall;
...
type
  LPOCNCONNPROCA = function(hSCardContext: Integer; hCard: LPSTR; pvUserData: Pointer): DWORD; cdecl;
{$EXTERNALSYM LPOCNCONNPROCA}
  LPOCNCONNPROCW = function(hSCardContext: Integer; hCard: LPWSTR; pvUserData: Pointer): DWORD; cdecl;
...
{$EXTERNALSYM LPOCNCONNPROC}
  LPOCNCHKPROC = function(hContext: Integer; hCard: LPSTR; pvUserData: Pointer): Bool; cdecl;
{$EXTERNALSYM LPOCNCHKPROC}
  LPOCNDSCPROC = procedure(hContext: Integer; hCard: LPSTR; pvUserData: Pointer); cdecl;
...
type
  TSCardUIDlgSelectCardA = function(pDlgStruc: LPOPENCARDNAME_EXA): Integer; stdcall;
  TSCardUIDlgSelectCardW = function(pDlgStruc: LPOPENCARDNAME_EXW): Integer; stdcall;
{$IFDEF UNICODE}
...
{$ELSE}
  ...
  // function SCardUIDlgSelectCardA(pDlgStruc: LPOPENCARDNAME_EXA): Integer; stdcall;
  // function SCardUIDlgSelectCardW(pDlgStruc: LPOPENCARDNAME_EXW): Integer; stdcall;
{$ENDIF}
  //
...
begin
  ...
  *)
  ...
  @SCardListReaderGroups := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardListReaderGroupsW'{$ELSE} 'SCardListReaderGroupsA'{$ENDIF});
  @SCardListReaders := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardListReadersW'{$ELSE} 'SCardListReadersA'{$ENDIF});
  @SCardListCards := GetProcAddress(hWinscardDLL, {$IFDEF UNICODE} 'SCardListCardsW'{$ELSE} 'SCardListCardsA'{$ENDIF});
  @SCardListInterfaces := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardListInterfacesW'{$ELSE} 'SCardListInterfacesALib'{$ENDIF});
  { SCardListInterfacesALib - alib? }
  @SCardGetProviderId := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardGetProviderIdW'{$ELSE} 'SCardGetProviderIdA'{$ENDIF});
  @SCardGetCardTypeProviderName := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardGetCardTypeProviderNameW'{$ELSE} 'SCardGetCardTypeProviderNameA'{$ENDIF});
  @SCardIntroduceReaderGroup := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardIntroduceReaderGroupW'{$ELSE} 'SCardIntroduceReaderGroupA'{$ENDIF});
  @SCardForgetReaderGroup := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardForgetReaderGroupW'{$ELSE} 'SCardForgetReaderGroupA'{$ENDIF});
  @SCardIntroduceReader := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardIntroduceReaderW'{$ELSE} 'SCardIntroduceReaderA'{$ENDIF});
  @SCardForgetReader := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardForgetReaderW'{$ELSE} 'SCardForgetReaderA'{$ENDIF});
  @SCardAddReaderToGroup := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardAddReaderToGroupW'{$ELSE} 'SCardAddReaderToGroupA'{$ENDIF});
  @SCardRemoveReaderFromGroup := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardRemoveReaderFromGroupW'{$ELSE} 'SCardRemoveReaderFromGroupA'{$ENDIF});
  @SCardIntroduceCardType := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardIntroduceCardTypeW'{$ELSE} 'SCardIntroduceCardTypeA'{$ENDIF});
  @SCardSetCardTypeProviderName := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardSetCardTypeProviderNameW'{$ELSE} 'SCardSetCardTypeProviderNameA'{$ENDIF});
  @SCardForgetCardType := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardForgetCardTypeW'{$ELSE} 'SCardForgetCardTypeA'{$ENDIF});
  @SCardFreeMemory := GetProcAddress(hWinscardDLL, 'SCardFreeMemory');
  @SCardLocateCards := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardLocateCardsW'{$ELSE} 'SCardLocateCardsA'{$ENDIF});
  @SCardGetStatusChange := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardGetStatusChangeW'{$ELSE} 'SCardGetStatusChangeA'{$ENDIF});
  ...
  @SCardLocateCardsByATR := GetProcAddress(hWinscardDLL,
    {$IFDEF UNICODE} 'SCardLocateCardsByATRW'{$ELSE} 'SCardLocateCardsByATRA'{$ENDIF});
...
function SCardRemoveReaderFromGroupA; external WinSCardDLL name 'SCardRemoveReader`FromGroupA';
